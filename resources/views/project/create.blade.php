        ...
        <form action="{{ route('project.store') }}" method="POST">
            ...
            <div class="row mb-3">
                <label for="project_name" class="col-md-4 col-form-label text-md-end">{{ __('Nama Project') }}</label>
                    <div class="col-md-6">
                        <input type="text" name="project_name" class="form-control" placeholder="Type project name" required/>
                    </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="project_description" class="col-md-4 col-form-label text-md-end">{{ __('Deskripsi Project') }}</label>
                    <div class="col-md-6">
                        <input type="text" name="project_description" class="form-control" placeholder="Type project description" required/>
                    </div>
            </div>
